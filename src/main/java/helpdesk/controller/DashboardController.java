...
//    private Button return_button;
    ...
    public void onCreateAction(ActionEvent actionEvent) {
        ...
        try {
            // TODO: Sukurti user klasės singleton objektą, nes jis šiuo metu lieka taip ir lieka prisijungimo langa
            RequestFormDAO.create(new RequestForm(requestType, email, title, description, isPictureIncluded, interests, User.getInstance().getUserID()));
