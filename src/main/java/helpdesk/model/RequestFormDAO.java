...
public class RequestFormDAO {
    ...
    public static void create(RequestForm requestForm) throws SQLException {
        ...
        PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO request_form (request_type, email, title, description, is_picture_included, area_of_interest, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)");
        ...
        preparedStatement.setInt(7, requestForm.getUserId());
